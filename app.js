...
app.post('/contact', (req, res) => {
    ...
    const mailOptions = {
        from: process.env.EMAIL_USER, // Utilisez la variable d'environnement pour l'adresse e-mail de l'expéditeur
        to: 'vicklionel@yahoo.fr', // Adresse e-mail de destination
        subject: sujet, // Utilisez le sujet fourni dans le formulaire
